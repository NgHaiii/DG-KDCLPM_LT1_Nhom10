...
@php
    ...
    $formatDate = function ($value, $fallback = 'Chưa cập nhật') {
        if (!$value) {
            return $fallback;
        }
    ...
    <div class="detail-header">
        <div>
            ...
            <div class="invoice-meta">
                <span><i class="ri-calendar-line"></i> Lập: {{ $formatDate($issuedAt) }}</span>
                <span><i class="ri-check-double-line"></i> Thanh toán: {{ $formatDate($paidAt, 'Chưa thanh toán') }}</span>
        ...
        <div class="header-actions">
            <a href="{{ route('employees.revenue.index') }}" class="action-btn">
            ...
            <div class="detail-card-body">
                <div class="info-grid">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-value">{{ $invoice->invoice_code ?? 'HD-' . $invoice->id }}</div>
                    </div>
                </div>
            </div>
        </div>
