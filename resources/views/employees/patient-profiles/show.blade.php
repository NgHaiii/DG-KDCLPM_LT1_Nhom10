...
@section('title', 'Chi tiết hồ sơ bệnh nhân')
@section('page-title', 'Chi tiết hồ sơ bệnh nhân')
@section('page-subtitle', 'Theo dõi thông tin hành chính, lịch sử khám, bệnh án, hình ảnh lâm sàng và sơ đồ răng')

@section('header-actions')
    <a href="{{ route('employees.patient-profiles.index') }}" class="admin-back-btn">
...
<div class="record-show-page">
    ...
    <div class="side-column">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="info-text">
                    Nhân viên/lễ tân được quyền xem hồ sơ để hỗ trợ tiếp nhận, điều phối khám bệnh và thanh toán.
                    Nội dung chuyên môn như chẩn đoán, điều trị, đơn thuốc và sơ đồ răng chỉ được cập nhật bởi bác sĩ phụ trách.
                </div>
            </div>
        </div>
    </div>
