...
<style>
    ...
    .stat-card.schedule { border-left-color: #10b981; }
    ...
    .stat-card.schedule p:last-child { color: #10b981; }
...
<div class="legend">
    <div class="legend-item">
        ...
        <span class="legend-text">📋 Ca làm việc được duyệt</span>
    </div>
    <div class="legend-item">
        <div class="legend-color legend-offday"></div>
        <span class="legend-text">🏖️ Ngày nghỉ được duyệt</span>
    </div>
</div>
...
<div class="calendar-container">
    <div class="calendar-header">
        ...
        <div class="calendar-nav">
            <button onclick="previousMonth()">← Tháng trước</button>
