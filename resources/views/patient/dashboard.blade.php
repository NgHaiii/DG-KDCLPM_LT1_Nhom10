...
<head>
    ...
    <title>Dashboard Bệnh nhân - DentalCare</title>
    <style>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">📅 Lịch khám của tôi</li>
                <li class="nav-item">📄 Hồ sơ cá nhân</li>
                <li class="nav-item">📝 Lịch sử khám bệnh</li>
        ...
        <div class="main">
            <div class="header">
                <div>
                    ...
                    <p style="color: #999; margin-top: 5px;">Quản lý lịch khám và hồ sơ của bạn</p>
                </div>
                <div class="user-info">
                    <div style="text-align: right;">
                        <p style="font-weight: 600;">{{ auth()->user()->name }}</p>
                        <p style="font-size: 12px; color: #999;">Bệnh nhân</p>
                    </div>
            ...
            <div class="card" style="text-align: center;">
                <h3>Bạn muốn đặt lịch khám mới?</h3>
                <button class="btn">➕ Đặt lịch khám ngay</button>
            </div>
        </div>
    </div>
</body>
