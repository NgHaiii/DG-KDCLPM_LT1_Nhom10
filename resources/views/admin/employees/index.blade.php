...
<head>
    ...
    <title>Quản lý nhân viên - DentalCare</title>
    <style>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('admin.doctors') }}">🩺 Quản lý bác sĩ</a></li>
                <li class="nav-item active"><a href="{{ route('admin.employees') }}">👨‍💼 Quản lý nhân viên</a></li>
            </ul>
        </div>
        ...
        <div class="main">
            <div class="header">
                <div>
                    ...
                    <p style="color: #999; margin-top: 5px;">Thêm, sửa, xóa thông tin nhân viên</p>
                </div>
            </div>
            ...
            <div class="form-card">
                <h2>{{ isset($editEmployee) ? '✏️ Sửa thông tin nhân viên' : '➕ Thêm nhân viên mới' }}</h2>
                <form method="POST" action="{{ isset($editEmployee) ? route('admin.employee.update', $editEmployee) : route('admin.employee.store') }}">
                    ...
                    <div class="form-group">
                        <label>Chức vụ *</label>
                        <input type="text" name="position" value="{{ old('position', $editEmployee->position ?? '') }}" placeholder="VD: Nhân viên tư vấn, Nha sĩ hỗ trợ" required>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">
                            {{ isset($editEmployee) ? '💾 Cập nhật' : '✅ Thêm nhân viên' }}
                        </button>
                        @if(isset($editEmployee))
                            <a href="{{ route('admin.employees') }}" class="btn btn-secondary">❌ Hủy</a>
                        @endif
                    </div>
                </form>
            </div>
            ...
            <div class="table-card">
                <h2>📋 Danh sách nhân viên ({{ count($employees) }} người)</h2>
                <table>
                    <thead>
                        <tr>
                            <th>Mã</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $emp->phone ?? '---' }}</td>
                            <td>
                                <form method="GET" action="{{ route('admin.employees') }}" style="display:inline">
                        ...
                        @empty
                        <tr>
                            <td colspan="6" style="text-align:center; color:#999;">Chưa có nhân viên nào</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
